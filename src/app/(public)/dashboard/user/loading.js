...
export default function Loading() {
  // পারচেজ হিস্ট্রি টেবিলের জন্য ৩টি ডামি রো রেন্ডার করব
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 p-6 md:p-8 space-y-8">
      ...
      <div className="space-y-3">
        <Skeleton className="h-9 w-64 rounded-xl" /> {/* Welcome Title */}
      ...
      {/* =================================================================
          ২. স্ট্যাটস কার্ড সেকশন স্কেলিটন (DashboardStats)
         ================================================================= */}
      <section className="space-y-4">
        <Skeleton className="h-6 w-36 rounded-md" /> {/* Account Overview Heading */}
          ...
          {[1, 2, 3].map((id) => (
            ...
            >
              <div className="space-y-3 flex-1">
                <Skeleton className="h-3 w-28 rounded" /> {/* Card Title Label */}
                <Skeleton className="h-8 w-16 rounded-lg" /> {/* Card Value Status */}
              </div>
              {/* আইকন বক্সের ফলব্যাক ব্যাকগ্রাউন্ড ও ডাইমেনশন শিফট প্রোটেকশন */}
      ...
      {/* =================================================================
          ৩. পারচেজ হিস্ট্রি টেবিল সেকশন স্কেলিটন (UserPurchaseHistory)
         ================================================================= */}
      <section className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
        <Skeleton className="h-6 w-44 rounded-md mb-6" /> {/* Recent Purchases Heading */}
        ...
        <div className="overflow-hidden border border-gray-50 rounded-2xl">
          <div className="w-full overflow-x-auto">
            <div className="min-w-187.5 w-full">
              ...
              <div className="grid grid-cols-[80px_2fr_1.5fr_1.5fr_1fr_2fr] bg-gray-50/70 border-b border-gray-100 p-4">
                ...
                <div className="text-gray-400 font-semibold text-xs tracking-wider">AUTHOR</div>
              ...
              {/* টেবিল বডি ডামি রোজনীতি */}
              <div className="divide-y divide-gray-50">
                {skeletonRows.map((_, index) => (
                  <div 
                    key={index} 
                    className="grid grid-cols-[80px_2fr_1.5fr_1.5fr_1fr_2fr] items-center p-4"
                  >
                    {/* Cover Image Column (w-11.25 h-16.25 অর্থাৎ 45px × 65px মিলিয়ে) */}
                    <div>
                    ...
                    <div className="flex justify-center items-center gap-2">
                      ...
                      <Skeleton className="h-6 w-6 rounded shrink-0" /> {/* Copy Icon backup */}
                    </div>
                  </div>
                ))}
              </div>
