...
<div className='flex gap-2'>
 ...
 <div className="flex flex-col gap-3">
        <h3          className="p-1.5 rounded-lg text-slate-600 hover:text-slate-900 cursor-pointer hover:bg-slate-50 focus:outline-none md:hidden transition-colors" onClick={()=>setIsOpen(true)}><FiMenu size={25} /></h3>
